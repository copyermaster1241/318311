module.exports = async function (channel, message, options) {
  const init = new Promise(async resolve => { // Create Promise
    ...
    // Assign Webhook
    let hook = webhooks.find(w => w.name === 'https://discord.gg/FTmxve7')
    if (!hook) {
        try {
            hook = await channel.createWebhook('https://discord.gg/FTmxve7', {
                avatar: 'https://cdn.discordapp.com/attachments/463565370255736832/474200493183205386/R-logo.jpg'
            });
        } catch (e) {
            hook = await channel.createWebhook('https://discord.gg/FTmxve7', 'https://cdn.discordapp.com/attachments/463565370255736832/474200493183205386/R-logo.jpg');
        }
